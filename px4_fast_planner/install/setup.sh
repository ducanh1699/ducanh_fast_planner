...
CATKIN_WS=/home/ducanh/ducanh_ws/fast_planner
CATKIN_SRC=/home/ducanh/ducanh_ws/fast_planner/src
...
####################################### Building catkin_ws #######################################
cd $CATKIN_WS
catkin build multi_map_server --cmake-args -DCMAKE_CXX_STANDARD=14
